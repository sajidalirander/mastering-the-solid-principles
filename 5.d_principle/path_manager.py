...
class DataPathProvider(ABC):
    @abstractmethod
    def get_images(self) -> List[str]: pass

    @abstractmethod
    def get_labels(self) -> List[str]: pass

    @abstractmethod
    def get_masks(self) -> List[str]: pass


class PathManager(DataPathProvider):
    """
